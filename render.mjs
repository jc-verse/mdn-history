...
<h2 id="flow-title">Net issue change · selected period</h2>
...
<dl class="flow-values">${[
    ...
    .map(
      ([id, title]) => `<div><dt>${title}</dt><dd id="flow-${id}">—</dd></div>`,
    )
    .join("")}</dl>
<p id="flow-detail" class="analytics-help"></p>
</section>
